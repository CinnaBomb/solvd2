...
public class StAXParsingExample extends DefaultHandler {
	...
	public static void main(String[] args) {
		try {
            ...
            XMLEventReader reader = factory.createXMLEventReader(new FileInputStream("C:\\Users\\House Games\\eclipse-workspace\\hospitalsystem\\src\\main\\resources\\Appointments.xml"));
